...
#CUDA_VISIBLE_DEVICES=3 python test.py --eval --skip_train --valloader colmapvalid --config configs/n3d_full/flame_steak.json  --model_path /root/hdd/bbangsik/checkpoints/SpacetimeGaussians/flame_steak --source_path /root/hdd/bbangsik/datasets/STG/data/flame_steak/colmap_0
